...
function App() {
  ...
  return (
    ...
    //           <div className="slider-thumb bg-fixed" style="background-image: url(assets/img/2440x1578.png);"></div>
    ...
    //       <div className="row">
    //         <div className="col-md-6 thumb bg-cover" style="background-image: url(assets/img/2440x1578.png);"></div>
    ...
    //             <div className="item" style="background-image: url(assets/img/800x600.png);">
    //               <a href="#">
    ...
    //             <div className="col-md-6 thumb bg-cover" style="background-image: url(assets/img/1500x700.png);">
    //               <div className="date">
