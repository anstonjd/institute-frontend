    ...
    <Navbar/>
        ...
        {/* <div id="bootcarousel" className="carousel slide animate_text carousel-fade" data-ride="carousel">
          ...
          <div className="carousel-inner text-light carousel-zoom">
            <div className="item active">
              <div className="slider-thumb bg-fixed" styles="background-image: url(assets/img/2440x1578.png);"></div>
                    ...
                    <div className="row">
                      <div className="col-md-8">
                        <div className="content">
                          ...
                          <a data-animation="animated slideInUp" className="btn btn-light border btn-md" href="#">Learn
                            more</a>
                          <a data-animation="animated slideInUp" className="btn btn-theme effect btn-md" href="#">View
                            Courses</a>
                        </div>
                      </div>
                    </div>
          ...
          <div className="row">
            <div className="about-info">
              ...
              <div className="col-md-6 info">
                ...
                <p>
                  Alteration literature to or an sympathize mr imprudence. Of is ferrars subject as enjoyed or tedious
                  cottage. Procuring as in resembled by in agreeable. Next long no gave mr eyes. Admiration advantages
                  no he celebrated so pianoforte unreserved. Not its herself forming charmed amiable. Him why feebly
                  expect future now.
                </p>
                <p>
                  ...
                  terminated man possession him attachment unpleasing melancholy. Sir smile arose one share. No abroad
                  in easily relied an whence lovers temper by. Looked wisdom common he an be giving length mr.
                  Dissuade ecstatic and properly saw entirely sir why laughter. frequently apartments off all
      ...
      <div className="wcs-area bg-dark text-light">
        <div className="container-full">
          <div className="row">
            <div className="col-md-6 thumb bg-cover" styles="background-image: url(assets/img/2440x1578.png);"></div>
            <div className="col-md-6 content">
              <div className="site-heading text-left">
                <h2>Why chose us</h2>
                <p>
                  Discourse assurance estimable applauded to so. Him everything melancholy uncommonly but solicitude
                  inhabiting projection off. Connection stimulated estimating excellence an to impression.
                </p>
              </div>
              ...
              <div className="item">
                ...
                <div className="info">
                  ...
                  <p>
                    Absolute required of reserved in offering no. How sense found our those gay again taken the. Had
                    mrs outweigh desirous sex overcame. Improved property reserved disposal do offering me.
                  </p>
                </div>
              </div>
            ...
            <div className="featured-courses-carousel owl-carousel owl-theme">
              ...
              <div className="item">
                <div className="col-md-5">
                  <div className="thumb">
                    ...
                    <div className="live-view">
                      <a href="assets/img/800x800.png" className="item popup-link">
                ...
                <div className="col-md-7 info">
                  ...
                  <a href="#" className="btn btn-theme effect btn-md" data-animation="animated slideInUp">Enroll
                    Now</a>
          ...
          <div className="row">
            <div className="top-cat-items">
              <div className="col-md-3 col-sm-6 equal-height">
                <div className="item" styles="background-image: url(assets/img/800x600.png);">
                  <a href="#">
          ...
          <div className="row">
            <div className="event-items">
              ...
              <div className="item horizontal col-md-12">
                <div className="col-md-6 thumb bg-cover" styles="background-image: url(assets/img/1500x700.png);">
                  <div className="date">
                ...
                <div className="col-md-6 info">
                  ...
                  <p>
                    Early had add equal china quiet visit. Appear an manner as no limits either praise in. In in
                    written on charmed justice is amiable farther besides. Law insensible middletons unsatiable for
            ...
            <div className="col-md-12">
              <div className="clients-review-carousel owl-carousel owl-theme">
                <div className="item">
                  ...
                  <div className="col-md-7 info">
                    <p>
                      Procuring continued suspicion its ten. Pursuit brother are had fifteen distant has. Early had
                      add equal china quiet visit. Appear an manner as no limits either praise..
                    </p>
                    <h4>Druna Patia</h4>
